...
**SessionSearcher (.NET 4.0+)** - Searches all connected drives for saved sessions information and parses them for relevant details. Based on [SessionGopher](https://github.com/Arvanaghi/SessionGopher) by @arvanaghi.  
